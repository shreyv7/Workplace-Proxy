...
function r$1(e, t, r) {
	return (t = n$1(t)) in e ? Object.defineProperty(e, t, {
		value: r,
		enumerable: !0,
		configurable: !0,
		writable: !0
...
var i$1 = class {
	...
	constructor() {
		r$1(this, `_lastHandleId`, 0), r$1(this, `_lastImmediate`, null);
	}
	requestAnimationFrame(e) {
	...
	constructor() {
		r$1(this, `_strategy`, void 0), this._strategy = typeof requestAnimationFrame == `function` ? new i$1() : new a$1();
	}
	requestAnimationFrame(e) {
...
var s$1 = typeof window < `u` && window.document !== void 0, c$1 = new Uint8Array([
	80,
	75,
	3,
	4
	...
	`w`,
	`h`
], u$1 = `0.75.0`, d$1 = `@lottiefiles/dotlottie-web`;
var f;
...
function g(e, t) {
	return e >>>= 0, p.decode(h().subarray(e, e + t));
}
function _(e) {
	let t = f.__externref_table_alloc_command_export();
	return f.__wbindgen_export_3.set(t, e), t;
}
function ee(e, t) {
	try {
		...
		let t = _(e);
		f.__wbindgen_exn_store_command_export(t);
	}
}
var v = 0;
var y = typeof TextEncoder < `u` ? new TextEncoder(`utf-8`) : { encode: () => {
	throw Error(`TextEncoder not available`);
} }, b = typeof y.encodeInto == `function` ? function(e, t) {
...
function x(e, t, n) {
	if (n === void 0) {
		let n = y.encode(e), r = t(n.length, 1) >>> 0;
		return h().subarray(r, r + n.length).set(n), v = n.length, r;
	}
	let r = e.length, i = t(r, 1) >>> 0, a = h(), o = 0;
	for (; o < r; o++) {
	...
	if (o !== r) {
		...
		let t = h().subarray(i + o, i + r), a = b(e, t);
...
var S = null;
function C() {
	return (S === null || S.buffer.detached === !0 || S.buffer.detached === void 0 && S.buffer !== f.memory.buffer) && (S = new DataView(f.memory.buffer)), S;
}
function w(e) {
	return e == null;
}
...
function ne(e, t) {
	...
	return te().set(e, n / 4), v = e.length, n;
}
function E(e, t) {
	let n = t(e.length * 1, 1) >>> 0;
	return h().set(e, n / 1), v = e.length, n;
}
function D(e, t) {
	let n = t(e.length * 4, 4) >>> 0;
	for (let t = 0; t < e.length; t++) {
		let r = _(e[t]);
		C().setUint32(n + 4 * t, r, !0);
	}
	return v = e.length, n;
}
function O(e, t) {
	let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v, i = E(t, f.__wbindgen_malloc_command_export), a = v;
	return f.register_font(n, r, i, a) !== 0;
}
var k = Object.freeze({
	Forward: 0,
	0: `Forward`,
	...
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => f.__wbg_dotlottieplayerwasm_free(e >>> 0, 1));
var j = class {
	__destroy_into_raw() {
	...
	free() {
		...
		f.__wbg_dotlottieplayerwasm_free(e, 0);
	}
	clear_slot(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_clear_slot(this.__wbg_ptr, t, n) !== 0;
	}
	is_playing() {
	...
	layout_fit() {
		let e, t;
		try {
			let n = f.dotlottieplayerwasm_layout_fit(this.__wbg_ptr);
			return e = n[0], t = n[1], g(n[0], n[1]);
		} finally {
			f.__wbindgen_free_command_export(e, t, 1);
		}
	}
	loop_count() {
	...
	reset_slot(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_reset_slot(this.__wbg_ptr, t, n) !== 0;
	}
	set_layout(e, t, n) {
		let r = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i = v;
		return f.dotlottieplayerwasm_set_layout(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	set_marker(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		f.dotlottieplayerwasm_set_marker(this.__wbg_ptr, t, n);
	}
	clear_slots() {
	...
	set_quality(e) {
		return f.dotlottieplayerwasm_set_quality(this.__wbg_ptr, e) !== 0;
	}
	set_segment(e, t) {
		return f.dotlottieplayerwasm_set_segment(this.__wbg_ptr, e, t) !== 0;
	}
	sm_set_seed(e) {
		return f.dotlottieplayerwasm_sm_set_seed(this.__wbg_ptr, e) !== 0;
	}
	static unload_font(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_unload_font(t, n) !== 0;
	}
	animation_id() {
		let e = f.dotlottieplayerwasm_animation_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = g(e[0], e[1]).slice(), f.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	audio_volume() {
	...
	get_slot_str(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_get_slot_str(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = g(r[0], r[1]).slice(), f.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	marker_names() {
		return f.dotlottieplayerwasm_marker_names(this.__wbg_ptr);
	}
	set_autoplay(e) {
		f.dotlottieplayerwasm_set_autoplay(this.__wbg_ptr, e);
	}
	set_slot_str(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v, i = x(t, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), a = v;
		return f.dotlottieplayerwasm_set_slot_str(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	set_viewport(e, t, n, r) {
		return f.dotlottieplayerwasm_set_viewport(this.__wbg_ptr, e, t, n, r) !== 0;
	}
	total_frames() {
	...
	get_slot_type(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_get_slot_type(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = g(r[0], r[1]).slice(), f.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	get_slots_str() {
		let e, t;
		try {
			let n = f.dotlottieplayerwasm_get_slots_str(this.__wbg_ptr);
			return e = n[0], t = n[1], g(n[0], n[1]);
		} finally {
			f.__wbindgen_free_command_export(e, t, 1);
		}
	...
	set_slots_str(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_set_slots_str(this.__wbg_ptr, t, n) !== 0;
	}
	set_text_slot(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v, i = x(t, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), a = v;
		return f.dotlottieplayerwasm_set_text_slot(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	set_transform(e) {
		let t = ne(e, f.__wbindgen_malloc_command_export), n = v;
		return f.dotlottieplayerwasm_set_transform(this.__wbg_ptr, t, n) !== 0;
	}
	sm_get_inputs() {
	...
	sm_post_click(e, t) {
		f.dotlottieplayerwasm_sm_post_click(this.__wbg_ptr, e, t);
	}
	animation_size() {
		return f.dotlottieplayerwasm_animation_size(this.__wbg_ptr);
	}
	current_marker() {
		let e = f.dotlottieplayerwasm_current_marker(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = g(e[0], e[1]).slice(), f.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	layout_align_x() {
	...
	load_animation(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_load_animation(this.__wbg_ptr, t, n) !== 0;
	}
	loop_animation() {
		return f.dotlottieplayerwasm_loop_animation(this.__wbg_ptr) !== 0;
	}
	set_background(e, t, n, r) {
		return f.dotlottieplayerwasm_set_background(this.__wbg_ptr, e, t, n, r) !== 0;
	}
	set_color_slot(e, t, n, r) {
		let i = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), a = v;
		return f.dotlottieplayerwasm_set_color_slot(this.__wbg_ptr, i, a, t, n, r) !== 0;
	}
	set_loop_count(e) {
		f.dotlottieplayerwasm_set_loop_count(this.__wbg_ptr, e);
	}
	set_theme_data(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_set_theme_data(this.__wbg_ptr, t, n) !== 0;
	}
	sm_reset_input(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		f.dotlottieplayerwasm_sm_reset_input(this.__wbg_ptr, t, n);
	}
	manifest_string() {
		let e, t;
		try {
			let n = f.dotlottieplayerwasm_manifest_string(this.__wbg_ptr);
			return e = n[0], t = n[1], g(n[0], n[1]);
		} finally {
			f.__wbindgen_free_command_export(e, t, 1);
		}
	...
	set_scalar_slot(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v;
		return f.dotlottieplayerwasm_set_scalar_slot(this.__wbg_ptr, n, r, t) !== 0;
	}
	set_vector_slot(e, t, n) {
		let r = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i = v;
		return f.dotlottieplayerwasm_set_vector_slot(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	setup_sw_target(e, t) {
		return f.dotlottieplayerwasm_setup_sw_target(this.__wbg_ptr, e, t) !== 0;
	}
	get_pixel_buffer() {
		return f.dotlottieplayerwasm_get_pixel_buffer(this.__wbg_ptr);
	}
	set_audio_volume(e) {
		f.dotlottieplayerwasm_set_audio_volume(this.__wbg_ptr, e);
	}
	sm_current_state() {
		let e, t;
		try {
			let n = f.dotlottieplayerwasm_sm_current_state(this.__wbg_ptr);
			return e = n[0], t = n[1], g(n[0], n[1]);
		} finally {
			f.__wbindgen_free_command_export(e, t, 1);
		}
	...
	state_machine_id() {
		let e = f.dotlottieplayerwasm_state_machine_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = g(e[0], e[1]).slice(), f.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	get_state_machine(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_get_state_machine(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = g(r[0], r[1]).slice(), f.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	set_position_slot(e, t, n) {
		let r = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i = v;
		return f.dotlottieplayerwasm_set_position_slot(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	current_loop_count() {
	...
	sm_post_pointer_up(e, t) {
		f.dotlottieplayerwasm_sm_post_pointer_up(this.__wbg_ptr, e, t);
	}
	state_machine_load(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_state_machine_load(this.__wbg_ptr, t, n) !== 0;
	}
	load_dotlottie_data(e) {
		let t = E(e, f.__wbindgen_malloc_command_export), n = v;
		return f.dotlottieplayerwasm_load_dotlottie_data(this.__wbg_ptr, t, n) !== 0;
	}
	sm_get_string_input(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_sm_get_string_input(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = g(r[0], r[1]).slice(), f.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	sm_set_string_input(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v, i = x(t, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), a = v;
		return f.dotlottieplayerwasm_sm_set_string_input(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	sm_get_boolean_input(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_sm_get_boolean_input(this.__wbg_ptr, t, n);
		return r === 16777215 ? void 0 : r !== 0;
	}
	sm_get_numeric_input(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v, r = f.dotlottieplayerwasm_sm_get_numeric_input(this.__wbg_ptr, t, n);
		return r === 4294967297 ? void 0 : r;
	}
	sm_post_pointer_down(e, t) {
		f.dotlottieplayerwasm_sm_post_pointer_down(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_exit(e, t) {
		f.dotlottieplayerwasm_sm_post_pointer_exit(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_move(e, t) {
		f.dotlottieplayerwasm_sm_post_pointer_move(this.__wbg_ptr, e, t);
	}
	sm_set_boolean_input(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v;
		return f.dotlottieplayerwasm_sm_set_boolean_input(this.__wbg_ptr, n, r, t) !== 0;
	}
	sm_set_numeric_input(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v;
		return f.dotlottieplayerwasm_sm_set_numeric_input(this.__wbg_ptr, n, r, t) !== 0;
	}
	state_machine_unload() {
		f.dotlottieplayerwasm_state_machine_unload(this.__wbg_ptr);
	}
	sm_post_pointer_enter(e, t) {
		f.dotlottieplayerwasm_sm_post_pointer_enter(this.__wbg_ptr, e, t);
	}
	load_animation_from_id(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_load_animation_from_id(this.__wbg_ptr, t, n) !== 0;
	}
	...
	sm_override_current_state(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v;
		return f.dotlottieplayerwasm_sm_override_current_state(this.__wbg_ptr, n, r, t) !== 0;
	}
	state_machine_load_from_id(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_state_machine_load_from_id(this.__wbg_ptr, t, n) !== 0;
	}
	set_use_frame_interpolation(e) {
		f.dotlottieplayerwasm_set_use_frame_interpolation(this.__wbg_ptr, e);
	}
	constructor() {
		let e = f.dotlottieplayerwasm_new();
	...
	tick(e) {
		return f.dotlottieplayerwasm_tick(this.__wbg_ptr, e) !== 0;
	}
	pause() {
	...
	sm_fire(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_sm_fire(this.__wbg_ptr, t, n) !== 0;
	}
	sm_stop() {
		return f.dotlottieplayerwasm_sm_stop(this.__wbg_ptr) !== 0;
	}
	sm_tick(e) {
		return f.dotlottieplayerwasm_sm_tick(this.__wbg_ptr, e) !== 0;
	}
	autoplay() {
	...
	set_loop(e) {
		f.dotlottieplayerwasm_set_loop(this.__wbg_ptr, e);
	}
	set_mode(e) {
		f.dotlottieplayerwasm_set_mode(this.__wbg_ptr, e);
	}
	sm_start(e, t) {
		let n = D(t, f.__wbindgen_malloc_command_export), r = v;
		return f.dotlottieplayerwasm_sm_start(this.__wbg_ptr, e, n, r) !== 0;
	}
	theme_id() {
		let e = f.dotlottieplayerwasm_theme_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = g(e[0], e[1]).slice(), f.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	is_loaded() {
	...
	load_font(e, t) {
		let n = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), r = v, i = E(t, f.__wbindgen_malloc_command_export), a = v;
		return f.dotlottieplayerwasm_load_font(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	set_frame(e) {
		return f.dotlottieplayerwasm_set_frame(this.__wbg_ptr, e) !== 0;
	}
	set_speed(e) {
		f.dotlottieplayerwasm_set_speed(this.__wbg_ptr, e);
	}
	set_theme(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_set_theme(this.__wbg_ptr, t, n) !== 0;
	}
	sm_status() {
		let e, t;
		try {
			let n = f.dotlottieplayerwasm_sm_status(this.__wbg_ptr);
			return e = n[0], t = n[1], g(n[0], n[1]);
		} finally {
			f.__wbindgen_free_command_export(e, t, 1);
		}
...
function N() {
	...
	return e.wbg = {}, e.wbg.__wbg_buffer_609cc3eee51ed158 = function(e) {
		...
		try {
			...
			f.__wbindgen_free_command_export(n, r, 1);
		}
		...
		let n = t.stack, r = x(n, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i = v;
		C().setInt32(e + 4, i, !0), C().setInt32(e + 0, r, !0);
	}, e.wbg.__wbindgen_init_externref_table = function() {
		let e = f.__wbindgen_export_3, t = e.grow(4);
		...
		var i = w(r) ? 0 : x(r, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), a = v;
		C().setInt32(e + 4, a, !0), C().setInt32(e + 0, i, !0);
...
function P(e, t) {
	return f = e.exports, F.__wbindgen_wasm_module = t, S = null, T = null, m = null, f.__wbindgen_start(), f;
}
async function F(e) {
	...
	let { instance: n, module: r } = await M(await e, t);
	return P(n, r);
}
var I = class {
	constructor() {
		r$1(this, `_eventListeners`, /* @__PURE__ */ new Map());
	}
...
r$1(L, `_observer`, null), r$1(L, `_observedCanvases`, /* @__PURE__ */ new Map());
var R = class e {
	static _initializeObserver() {
...
r$1(R, `_observer`, null), r$1(R, `_observedCanvases`, /* @__PURE__ */ new Map());
function re(e) {
...
function z(e) {
	...
	let t = new Uint8Array(e.slice(0, c$1.byteLength));
	for (let e = 0; e < c$1.length; e += 1) if (c$1[e] !== t[e]) return !1;
	return !0;
}
function B(e) {
	return l$1.every((t) => Object.hasOwn(e, t));
}
function V(e) {
...
function H() {
	return 1 + ((s$1 ? window.devicePixelRatio : 1) - 1) * .75;
}
function U(e) {
...
var q = K(F, `https://cdn.jsdelivr.net/npm/${d$1}@${u$1}/dist/dotlottie-player.wasm`, `https://unpkg.com/${d$1}@${u$1}/dist/dotlottie-player.wasm`), J = (e) => {
	switch (e) {
		case `reverse`: return k.Reverse;
		case `bounce`: return k.Bounce;
		case `reverse-bounce`: return k.ReverseBounce;
		default: return k.Forward;
	}
}, Y = (e) => {
	switch (e) {
		case k.Reverse: return `reverse`;
		case k.Bounce: return `bounce`;
		case k.ReverseBounce: return `reverse-bounce`;
...
var ae = class {
	constructor(e) {
		r$1(this, `_canvas`, null), r$1(this, `_pendingLoad`, null), r$1(this, `_context`, null), r$1(this, `_eventManager`, void 0), r$1(this, `_animationFrameId`, null), r$1(this, `_frameManager`, void 0), r$1(this, `_boundAnimationLoop`, void 0), r$1(this, `_dotLottieCore`, null), r$1(this, `_stateMachineId`, ``), r$1(this, `_stateMachineConfig`, null), r$1(this, `_isStateMachineRunning`, !1), r$1(this, `_renderConfig`, {}), r$1(this, `_isFrozen`, !1), r$1(this, `_backgroundColor`, null), r$1(this, `_lastFrameTime`, null), r$1(this, `_boundOnClick`, null), r$1(this, `_boundOnPointerUp`, null), r$1(this, `_boundOnPointerDown`, null), r$1(this, `_boundOnPointerMove`, null), r$1(this, `_boundOnPointerEnter`, null), r$1(this, `_boundOnPointerLeave`, null), r$1(this, `_bufferMismatchCount`, 0), r$1(this, `_lastExpectedBufferSize`, 0), r$1(this, `_cachedImageData`, null), r$1(this, `_cachedImageDataBuffer`, null), r$1(this, `_cachedImageDataByteOffset`, 0), r$1(this, `_marker`, ``), r$1(this, `_segment`, null), this._canvas = e.canvas ?? null, this._eventManager = new I(), this._frameManager = new o$1(), this._boundAnimationLoop = this._animationLoop.bind(this), this._renderConfig = {
			...e.renderConfig,
			devicePixelRatio: e.renderConfig?.devicePixelRatio || H(),
	...
	_drainSmEvents() {
		...
		for (; (t = this._dotLottieCore.sm_poll_internal_event()) != null;) {
			...
			if (e.type === `Message`) {
				let t = e.message ?? ``;
				s$1 && t.startsWith(`OpenUrl: `) ? G(t) : this._eventManager.dispatch({
	...
	async _fetchData(e) {
		...
		return z(n) ? n : new TextDecoder().decode(n);
	}
	_loadFromData(e) {
		...
		let t = this._canvas.width, n = this._canvas.height;
		...
		if (typeof e == `string`) {
			...
			r = this._dotLottieCore.load_animation(JSON.stringify(e));
		} else {
		...
		if (r) {
			if (this._renderConfig.quality !== void 0 && this._dotLottieCore.set_quality(this._renderConfig.quality), s$1 && this.resize(), this._drainPlayerEvents({ skipFrame: !!this._marker || !!this._segment }), this._marker && this._dotLottieCore.set_marker(this._marker), this._segment) {
	...
	_cleanupCanvas() {
		this._canvas && s$1 && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas), this._cleanupStateMachineListeners());
	}
	_initializeCanvas() {
		this._setupRendererOnCanvas(), this._canvas && s$1 && this._canvas instanceof HTMLCanvasElement && this.isLoaded && (this._renderConfig.freezeOnOffscreen && (L.observe(this._canvas, this), U(this._canvas) || this.freeze()), this._renderConfig.autoResize && R.observe(this._canvas, this), this._isStateMachineRunning && this._setupStateMachineListeners()), this._canvas && this._dotLottieCore && this.isLoaded && this._setupTarget(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
	}
	...
	play() {
		...
		this._drainPlayerEvents(), (e || this._dotLottieCore.is_playing()) && (this._isFrozen = !1, this._startAnimationLoop()), this._canvas && s$1 && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !U(this._canvas) && this.freeze();
	}
	pause() {
	...
	setBackgroundColor(e) {
		if (this._dotLottieCore !== null) {
			if (s$1 && this._canvas instanceof HTMLCanvasElement) this._canvas.style.backgroundColor = e;
			else {
				let [t, n, r, i] = ie(e);
	...
	resize() {
		if (!(!this._dotLottieCore || !this.isLoaded || !this._canvas)) {
			if (s$1 && this._canvas instanceof HTMLCanvasElement) {
	...
	stateMachineStop() {
		...
		return this._drainSmEvents(), e && (this._isStateMachineRunning = !1, this._cleanupStateMachineListeners(), this._dotLottieCore.is_playing() || this._stopAnimationLoop()), e;
	}
	...
	_setupStateMachineListeners() {
		if (s$1 && this._canvas instanceof HTMLCanvasElement && this._dotLottieCore !== null && this.isLoaded) {
	...
	_cleanupStateMachineListeners() {
		s$1 && this._canvas instanceof HTMLCanvasElement && (this._boundOnClick && (this._canvas.removeEventListener(`click`, this._boundOnClick), this._boundOnClick = null), this._boundOnPointerUp && (this._canvas.removeEventListener(`pointerup`, this._boundOnPointerUp), this._boundOnPointerUp = null), this._boundOnPointerDown && (this._canvas.removeEventListener(`pointerdown`, this._boundOnPointerDown), this._boundOnPointerDown = null), this._boundOnPointerMove && (this._canvas.removeEventListener(`pointermove`, this._boundOnPointerMove), this._boundOnPointerMove = null), this._boundOnPointerEnter && (this._canvas.removeEventListener(`pointerenter`, this._boundOnPointerEnter), this._boundOnPointerEnter = null), this._boundOnPointerLeave && (this._canvas.removeEventListener(`pointerleave`, this._boundOnPointerLeave), this._boundOnPointerLeave = null));
	}
}, oe = class {
	constructor() {
	...
	constructor() {
		r$1(this, `_workers`, /* @__PURE__ */ new Map()), r$1(this, `_animationWorkerMap`, /* @__PURE__ */ new Map()), r$1(this, `_eventHandlers`, /* @__PURE__ */ new Map()), r$1(this, `_rpcHandlers`, /* @__PURE__ */ new Map()), r$1(this, `_routeMessage`, (e) => {
			let t = e.data;
			if (t.id) {
			...
			if (n) {
				let t = this._eventHandlers.get(n);
				t && t(e);
			}
		});
	}
	getWorker(e) {
		...
		return t || (t = new oe(), t.addEventListener(`message`, this._routeMessage), this._workers.set(e, t)), t;
	}
	...
	terminateWorker(e) {
		let t = this._workers.get(e);
		t && (t.removeEventListener(`message`, this._routeMessage), t.terminate(), this._workers.delete(e));
	}
...
var $ = class e {
	constructor(t) {
		if (r$1(this, `_eventManager`, new I()), r$1(this, `_id`, void 0), r$1(this, `_worker`, void 0), r$1(this, `_canvas`, void 0), r$1(this, `_dotLottieInstanceState`, {
			loopCount: 0,
			markers: [],
			autoplay: !1,
			backgroundColor: ``,
			...
			renderConfig: { devicePixelRatio: H() },
			activeAnimationId: ``,
			activeThemeId: ``,
			layout: void 0,
			marker: ``,
			isReady: !1,
			manifest: null
		}), r$1(this, `_created`, !1), r$1(this, `_boundOnClick`, null), r$1(this, `_boundOnPointerUp`, null), r$1(this, `_boundOnPointerDown`, null), r$1(this, `_boundOnPointerMove`, null), r$1(this, `_boundOnPointerEnter`, null), r$1(this, `_boundOnPointerLeave`, null), r$1(this, `_pendingConfig`, null), t.canvas) {
		...
		this._canvas = t.canvas ?? null, this._id = `dotlottie-${Q()}`;
	...
	async setCanvas(e) {
		let t = typeof HTMLCanvasElement < `u` && e instanceof HTMLCanvasElement, n = typeof OffscreenCanvas < `u` && e instanceof OffscreenCanvas;
		if (!t && !n) throw Error(`Worker-based DotLottie requires HTMLCanvasElement or OffscreenCanvas`);
		if (this._canvas !== e) {
	...
	async play() {
		this._created && (await this._sendMessage(`play`, { instanceId: this._id }), await this._updateDotLottieInstanceState(), s$1 && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !U(this._canvas) && await this.freeze());
	}
	async pause() {
	...
	async setTheme(e) {
		...
		let t = await this._sendMessage(`setTheme`, {
			instanceId: this._id,
			themeId: e
		});
	...
	async load(e) {
		if (!this._created) {
			this._pendingConfig && (this._pendingConfig = {
				...this._pendingConfig,
				...e
			});
			return;
	...
	async setLoopCount(e) {
		this._created && (await this._sendMessage(`setLoopCount`, {
			instanceId: this._id,
			loopCount: e
		}), await this._updateDotLottieInstanceState());
	}
	async resize() {
		...
		let { height: e, width: t } = Z(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || H());
	...
	async destroy() {
		this._created && (this._created = !1, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e._workerManager.unregisterEventHandler(this._id), e._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), s$1 && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas)));
	}
	async freeze() {
	...
	async setSlots(e) {
		this._created && await this._sendMessage(`setSlots`, {
			instanceId: this._id,
			slots: e
		});
	}
	...
	async animationSize() {
		return this._created ? this._sendMessage(`animationSize`, { instanceId: this._id }) : {
			height: 0,
			width: 0
		};
	}
	...
	async _sendMessage(t, n, r) {
		...
		return new Promise((n, a) => {
			e._workerManager.registerRpcReplyHandler(i.id, (r) => {
				e._workerManager.unregisterRpcReplyHandler(i.id);
				let o = r.data;
				o.error ? a(Error(`Failed to execute method ${t}: ${o.error}`)) : n(o.result);
	...
	static async registerFont(t, n) {
		try {
			...
			return console.error(`Error broadcasting registerFont for "${t}":`, e), !1;
		}
	}
	async stateMachineLoad(e) {
		if (!this._created) return !1;
		let t = await this._sendMessage(`stateMachineLoad`, {
			instanceId: this._id,
			stateMachineId: e
		});
		return await this._updateDotLottieInstanceState(), t;
	...
	async stateMachineLoadData(e) {
		if (!this._created) return !1;
		let t = await this._sendMessage(`stateMachineLoadData`, {
			instanceId: this._id,
			stateMachineData: e
		});
		return await this._updateDotLottieInstanceState(), t;
	...
	async stateMachineSetNumericInput(e, t) {
	...
	async stateMachineSetBooleanInput(e, t) {
	...
	async stateMachineSetStringInput(e, t) {
	...
	async stateMachineOverrideState(e, t = !1) {
	...
	async stateMachinePostClickEvent(e, t) {
	...
	async stateMachinePostPointerUpEvent(e, t) {
	...
	async stateMachinePostPointerDownEvent(e, t) {
	...
	async stateMachinePostPointerMoveEvent(e, t) {
	...
	async stateMachinePostPointerEnterEvent(e, t) {
	...
	async stateMachinePostPointerExitEvent(e, t) {
	...
	async _setupStateMachineListeners() {
		if (s$1 && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
...
r$1($, `_workerManager`, new se()), r$1($, `_wasmUrl`, ``);
//#endregion
//#region node_modules/@lottiefiles/dotlottie-react/dist/index.js
var import_react = /* @__PURE__ */ __toESM(require_react(), 1), import_jsx_runtime = require_jsx_runtime(), o = ({ animationId: e, autoplay: t, backgroundColor: o, className: s, createDotLottie: c, data: l, dotLottieRefCallback: u, layout: d, loop: f, mode: p, playOnHover: m, renderConfig: h, segment: g, speed: _, src: v, stateMachineConfig: y, stateMachineId: b, style: x, themeData: S, themeId: C, useFrameInterpolation: w, workerId: T, ...E }) => {
	let D = (0, import_react.useRef)(null), O = (0, import_react.useRef)(null), k = (0, import_react.useRef)(u), A = {
		speed: _,
		mode: p,
		loop: f,
	...
	return (0, import_react.useEffect)(() => {
		...
		D.current?.setBackgroundColor(o ?? ``);
	}, [o]), (0, import_react.useEffect)(() => {
		D.current?.setRenderConfig(h ?? {});
	}, [JSON.stringify(h)]), (0, import_react.useEffect)(() => {
	...
	}, [E.marker]), (0, import_react.useEffect)(() => {
	...
	}, [y]), (0, import_jsx_runtime.jsx)(`div`, {
		className: s,
		...!s && { style: {
			width: `100%`,
			height: `100%`,
...
}, s = (t) => new ae(t), c = (e) => (0, import_jsx_runtime.jsx)(o, {
	...e,
	createDotLottie: s
});
//#endregion
export { require_jsx_runtime as n, require_react as r, c as t };
